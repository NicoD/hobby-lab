...
use App\ColorLab\Catalog\Application\Color\Command\CreateColor\CreateColorCommand;
use App\ColorLab\Catalog\Application\Color\Query\GetColor\GetColorQuery;
use App\ColorLab\Catalog\Application\Color\Query\ListColors\ListColorsQuery;
...
final class ColorController extends AbstractController
{
    ...
    #[Route('/color-lab/catalog/colors', name: 'list', methods: ['GET'])]
    ...
    #[Route('/color-lab/catalog/colors', name: 'create', methods: ['POST'])]
    ...
    #[Route('/color-lab/catalog/colors/{handle}', name: 'get', methods: ['GET'])]
