...
use App\ColorLab\Catalog\Application\Brand\Command\CreateBrand\CreateBrandCommand;
use App\ColorLab\Catalog\Application\Brand\Query\GetBrand\GetBrandQuery;
use App\ColorLab\Catalog\Application\Brand\Query\ListBrands\ListBrandsQuery;
...
final class BrandController extends AbstractController
{
    ...
    #[Route('/color-lab/catalog/brands', name: 'list', methods: ['GET'])]
    ...
    #[Route('/color-lab/catalog/brands', name: 'create', methods: ['POST'])]
    ...
    #[Route('/color-lab/catalog/brands/{handle}', name: 'get', methods: ['GET'])]
