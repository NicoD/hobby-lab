...
function ColorLabCircleIcon({ className }: { className: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
    ...
    >
      ...
      <g transform="rotate(135, 12, 12)">
        ...
        <path
          fill="currentColor"
          stroke="none"
          d="M12 8 C7.5 9.5 7 14.5 12 20 C17 14.5 16.5 9.5 12 8 Z"
        />
      </g>
    </svg>
  );
...
function MiniLabCircleIcon({ className }: { className: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
